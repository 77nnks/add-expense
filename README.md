...
| クレジットカード | カード, クレカ, VISA |

## コマンド

- `ヘルプ` または `help` - 使い方を表示（現在の選択肢一覧も表示）
- `集計` または `今月` - 今月の支出合計を表示
- `更新` または `reload` - NotionDBから選択肢を再取得
...
トーク画面下部にボタンメニューを表示できます。

#### 画像の準備

`assets/richmenu.png` を作成してください：
...
※ LINE Official Account Manager からGUIで設定することも可能です。
